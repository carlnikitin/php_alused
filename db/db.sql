...
--
-- Database: `carlniki_php`
--
CREATE DATABASE IF NOT EXISTS `carlniki_php` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `carlniki_php`;
...
(1, 'Kasutaja', '5f4dcc3b5aa765d61d8327deb882cf99', 'name1', 'name2');
